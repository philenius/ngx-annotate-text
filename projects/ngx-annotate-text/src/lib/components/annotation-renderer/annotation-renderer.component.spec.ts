...
describe('AnnotationRendererComponent', () => {
  ...
  const getAnnotationParentElement = (): HTMLElement =>
    fixture.nativeElement.querySelector('button.annotation-parent');

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [NgxAnnotationRendererComponent],
    }).compileComponents();

    fixture = TestBed.createComponent(NgxAnnotationRendererComponent);
    component = fixture.componentInstance;
    fixture.componentRef.setInput('clickAnnotation', vi.fn());
    fixture.componentRef.setInput('removeAnnotation', vi.fn());
  });
