...
describe('TokenizerService', () => {
  ...
  it('should split the text into the correct tokens if given one annotation at the beginning of the text', () => {
    const annotations = [new Annotation(0, 2, 'Start Token', 'red')];
    const text =
    ...
    expect(actualTokens[0]).toBeInstanceOf(Annotation);
  ...
  it('should split the text into the correct tokens if given one annotation at the end of the text', () => {
    const annotations = [new Annotation(83, 86, 'End Token', 'green')];
    const text =
      'On August 1, we went on vacation to Barcelona, Spain. Our flight took off at 11:00 am.';
    ...
    expect(actualTokens[0]).toBe(
      'On August 1, we went on vacation to Barcelona, Spain. Our flight took off at 11:00 ',
    );

    expect(actualTokens[1]).toBeInstanceOf(Annotation);
  ...
  it('should split the text into the correct tokens if given one annotation in the middle of the text', () => {
    const annotations = [new Annotation(36, 45, 'City', '#fff')];
    const text =
      'On August 1, we went on vacation to Barcelona, Spain. Our flight took off at 11:00 am.';
